...
from UniDxMD.common.config.base import CN, _C
...
_C.TRAIN.XMUDA.lambda_VQ = 1.0
_C.TRAIN.XMUDA.lambda_LSR = 0.1
_C.TRAIN.XMUDA.lambda_ICC = 0.1
_C.TRAIN.XMUDA.lambda_pl_2d = 0.5
...
# _C.DATASET_SOURCE.NuScenesLidarSegSCN.use_rgb = False  #  use rgb feature or no
_C.DATASET_SOURCE.NuScenesLidarSegSCN.merge_classes_style = 'nuScenes_intra'
# 3D
...
_C.DATASET_SOURCE.A2D2SCN.merge_classes_style = 'A2D2_sKITTI'
# _C.DATASET_SOURCE.A2D2SCN.use_rgb = False  #  use rgb feature or no
...
_C.DATASET_SOURCE.SemanticKITTISCN.use_color = False  #  use rgb feature or no
...
# _C.DATASET_SOURCE.VirtualKITTISCN.use_rgb = False  #  use rgb feature or no
_C.DATASET_SOURCE.VirtualKITTISCN.use_color = False
# 3D
...
_C.MODEL_2D.CODEBOOK_NUM = 128
_C.MODEL_2D.CODEBOOK_DIM = 128
_C.MODEL_2D.sigma = 1.0
...
_C.MODEL_3D.sigma = 1.0
_C.MODEL_3D.USE_COLOR = False
...
_C.OUTPUT_DIR = osp.expanduser('~/workspace/outputs/UniDxMD/@')