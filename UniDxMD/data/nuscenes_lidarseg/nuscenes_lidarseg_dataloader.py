...
from UniDxMD.data.utils.refine_pseudo_labels import refine_pseudo_labels
...
def test_NuScenesSCN():
    from UniDxMD.data.utils.visualize import draw_points_image_labels, draw_points_image_depth, draw_bird_eye_view
