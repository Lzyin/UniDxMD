...
from UniDxMD.common.utils.torch_util import worker_init_fn
from UniDxMD.data.collate import get_collate_scn
from UniDxMD.common.utils.sampler import IterationBasedBatchSampler
from UniDxMD.data.nuscenes_lidarseg.nuscenes_lidarseg_dataloader import NuScenesLidarSegSCN
from UniDxMD.data.a2d2.a2d2_dataloader import A2D2SCN
from UniDxMD.data.semantic_kitti.semantic_kitti_dataloader import SemanticKITTISCN
from UniDxMD.data.virtual_kitti.virtual_kitti_dataloader import VirtualKITTISCN
...
def build_dataloader(cfg, mode='train', domain='source', start_iteration=0, different_batch_size=None):
    ...
    if dataset_cfg.TYPE == 'NuScenesSCN':
        ...
        dataset = NuScenesLidarSegSCN(split=split,
                                      output_orig=not is_train,
                                      data_type=cfg.DATASET_TARGET.TYPE,
                                      **dataset_kwargs,
                                      **augmentation)
